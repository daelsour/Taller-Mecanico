<template>
    <div class="card">
        <div class="information">
            <span>Alicates</span>
                <p>Las pinzas o alicates son herramientras clave<br>
                para llevar a cabo diversas tareas.</p>
        </div>
    ...
    <div class="card-1">
        <div class="information-1">
            <span>Matracas </span>
                <p>Su función es aflojar o ajustar pernos de forma<br>
                cómoda haciendo palanca para que sea más sencillo.</p>
        </div>
        <button class="viewmore">Ver más</button>
    </div>
    <div class="card-2">
        <div class="information-1">
            <span>Matracas X2</span>
                <p>Su función es aflojar o ajustar pernos de forma<br>
                cómoda haciendo palanca para que sea más sencillo.</p>
        </div>
        <button class="viewmore">Ver más</button>
